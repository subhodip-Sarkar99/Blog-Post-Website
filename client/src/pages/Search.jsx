        ...
        <div className="flex flex-col md:flex-row font-Montserrat">
            <div className="p-7 border-b md:border-r md: min-h-screen border-gray-500">
                <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
                    <div className="flex items-center gap-2">
                        ...
                        <input type="text" placeholder="Search..." id="searchTerm" className="input input-bordered input-info w-full max-w-xs"
                    ...
                    <button type="submit" className="btn btn-outline btn-info">Apply Filters</button>
                </form>
            ...
            <div className="w-full">
                ...
                <div className="p-7 flex flex-wrap gap-4">
                    {
                        !loading && posts.length===0 && <p className="text-xl text-gray-500">No Posts Founds</p>
                    }
                    {
